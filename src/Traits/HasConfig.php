...
namespace Aleksandr\SberbankAcquiring\Traits;

use Aleksandr\SberbankAcquiring\Exceptions\ConfigException;
use Exception;
...
trait HasConfig
{
     ...
     * @throws \Aleksandr\SberbankAcquiring\Exceptions\ConfigException
     */
